...
class InspirationTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            let cell = tableView.dequeueReusableCell(withIdentifier: "headingWithInfoTextCell", for: indexPath) as!ScreenHeadingWithInfoTextTableViewCell
            cell.screenTitle.text = "New Goal"
            cell.infoText.text = "You can create a Goal for yourself, send a Goal to a friend or be inspired by popular Goals."
            return cell
